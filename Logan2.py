...
print("Requests made throughout duration of log period:", number_of_requests_total, "\n")

print("------------- Requests By Days of the Week -------------")
for weekday_name in days:
    print(weekday_name, ":", days[weekday_name])
    
print()

print("------------- Requests By Week Numbers -------------")
...
print("Percentage of Requests as Errors (4xx errors): ", round((number_of_error * 100) / number_of_requests_total, 2), "%")
print("Percentage of Requests as Redirects(3xx errors): ", round((number_of_redirect * 100) / number_of_requests_total, 2), "%")
